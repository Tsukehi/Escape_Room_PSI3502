...
public class SamplerController : MonoBehaviour
{
    ...
    */
    ...
    bool checkPosition()
    {
        ...
        if (box054pos.value == 1.0f){box054ok = true;}
        if (box055pos.value == 1.0f){box055ok = true;}
        if (box056pos.value == 0.0f){box056ok = true;}
        if (box057pos.value == 1.0f){box057ok = true;}
        if (box058pos.value == 1.0f){box058ok = true;}
        if (box059pos.value == 1.0f){box059ok = true;}
        if (box060pos.value == 1.0f){box060ok = true;}
        if (box061pos.value == 0.0f){box061ok = true;}
        if (box062pos.value == 0.0f){box062ok = true;}
        if (box063pos.value == 1.0f){box063ok = true;}
        if (box064pos.value == 1.0f){box064ok = true;}
